...
function List() {
  const { flash, module, auth, course_id } = usePage().props;
  console.log(module);
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        router.delete(route('admin.course-module.destroy', id));
      }
    });
  };
          ...
          <div className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-3">
                {auth.user.permissions.includes('course_module.create') &&
                  <Link href={route('admin.course-module.create', { id: course_id })}>
                    <PrimaryButton>
                      Create
                    </PrimaryButton>
                  </Link>
                    ...
                    module.data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-right space-x-2">
                          ...
                          {auth.user.permissions.includes('course_content.view') &&
                            <Link href={route('admin.course-content.index', { module_id: item.id, course_id: course_id })}>
                          ...
                          {auth.user.permissions.includes('course_module.update') &&
                            <Link href={route('admin.course-module.edit', item.id)}>
                              <PrimaryButton
                                size='sm'
                              >
                                Edit
                          ...
                          {auth.user.permissions.includes('course_module.delete') &&
                            <DangerButton
                              size="sm"
