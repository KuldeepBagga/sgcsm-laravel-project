...
function List() {
    const { flash, auth, assign_exam } = usePage().props;
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route('admin.online-exam-assign.destroy', id));
            }
        });
    };
                ...
                <div className="mx-auto max-w-10xl sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6">
                        ...
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <Link href={route('admin.online-exam-assign.create')}>
                                <PrimaryButton>
                                    Create
                                </PrimaryButton>
                            </Link>
                        ...
                        <div className="w-full overflow-x-auto">
                            <table className="min-w-full border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden border-solid">
                                ...
                                <tbody className="divide-y divide-gray-200 dark:divide-gray-700 bg-gray-900">
                                    ...
                                    {assign_exam?.data?.length > 0 ? (
                                        assign_exam.data.map((item, index) => (
                                            <tr
                                                key={item.id || index}
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 text-right space-x-2">
                                                    ...
                                                    <Link href={route('admin.online-exam-assign.edit', item.id)}>
                                                        <PrimaryButton
                                                            size='sm'
                                                        >
                                                            Edit
                        ...
                        <Pagination
                            links={assign_exam?.links}
                            from={assign_exam?.from}
                            to={assign_exam?.to}
                            total={assign_exam?.total}
                        />
                    </div>
                </div>
            </div>
