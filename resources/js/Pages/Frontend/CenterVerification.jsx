...
function CenterVerification() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        post(route('center-verification.post'), {
            preserveScroll: true,
            preserveState: true,
            onSuccess: () => {
                reset()
    ...
    return (
        <MainLayout>
            <Head title="Center Verification" />
                            ...
                            <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
                                ...
                                <div className="overflow-x-auto">
                                    ...
                                    <table className="w-full">
                                        ...
                                        <thead className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white">
                                            <tr>
                                                ...
                                                <th className="px-6 py-4 text-left font-semibold">State & District</th>
                                            </tr>
                                        </thead>
                                                ...
                                                <td className="px-6 py-5">
                                                    <div>
                                                        <p className="font-semibold text-gray-800">
                                                            {center.center_code.toUpperCase()}
                                                        </p>
                                                    </div>
                                                </td>

                                                <td className="px-6 py-5 text-gray-600">
                                                    {center.state.toUpperCase()}, {center.district.toUpperCase()}
                                                </td>
                                    ...
                                    <div className="flex justify-center items-center py-5">
                                        <Link
                                            href={route('center-verification.index')}
                                            type="button"
