            ...
            <main class="bg-slate-50">
                ...
                <section class="max-w-5xl mx-auto px-6 py-10">
                    <div class="bg-white rounded-3xl shadow-lg border overflow-hidden">
                        ...
                        <div class="flex items-center justify-between p-5 border-b hover:bg-gray-50 transition">
                            ...
                            <a href="#"
                                class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-xl text-sm font-medium transition">
                                Download
                            </a>
                        </div>
